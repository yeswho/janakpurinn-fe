...
const hardcodedRooms: RoomType[] = [
  ...
  },
  {
    ...
    images: {
      ...
      gallery: [
        'https://i.ibb.co/wZbs54m5/Double-Bed-Deluxe2.jpg',
        'https://i.ibb.co/N2B61VRb/Double-Bed-Deluxe.jpg',
        'https://i.ibb.co/8n1cn2J7/Double-Bed-Standard.jpg',
        'https://i.ibb.co/9mMLPbxn/Double-Bed-Standard3.jpg'
      ],
    },
    availableRooms: 4,
  },
  {
    id: 'std-002',
    title: '3 single bed room with A/C',
    category: 'Standard',
    description: 'A comfortable room with a single bed, flat screen tv, furniture closet (ATTACHED WASHROOM)',
    price: 3500,
    size: '250 sq.ft',
    capacity: '3 Adults',
    amenities: ['3 Single beds', 'Attached washroom', 'Ceiling fan', 'Free WiFi', 'Daily housekeeping', 'Room service', 'Silent neighborhood', '24 hr running water'],
    images: {
      main: '/1000059129.webp',
      gallery: ['/1000059128.webp'],
    },
    availableRooms: 2,
  },
];
